...
#+CAPTION: Clock summary at [2022-12-02 Fri 14:32]
| Headline                                     | Time       |      |
|----------------------------------------------+------------+------|
| *Total time*                                 | *2d 19:47* |      |
|----------------------------------------------+------------+------|
| WASM Actions                                 | 2d 19:47   |      |
...
:END:
** STRT Implement "Virtual filesystems" that store the directory prefixes
:LOGBOOK:
CLOCK: [2022-12-07 Wed 14:09]--[2022-12-07 Wed 14:58] =>  0:49
:END:
** TODO Expose storage directory management on frontend

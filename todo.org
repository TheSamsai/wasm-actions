...
#+CAPTION: Clock summary at [2022-12-22 to 16:09]
| Headline                                     | Time       |      |
|----------------------------------------------+------------+------|
| *Total time*                                 | *3d 12:23* |      |
|----------------------------------------------+------------+------|
| WASM Actions                                 | 3d 12:23   |      |
...
:END:
** TODO Create a quick and simple logo to be loaded as app icon
** TODO Create a more comprehensive "landing page"
** TODO Make error messages and notifications automatically disappear after a while
